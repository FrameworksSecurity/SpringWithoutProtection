...
public class PostController {
	...
	public String save(Model model, @Valid Post post, BindingResult result, RedirectAttributes attrs) {
		String created_atFormatted = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss")
				.format(Calendar.getInstance().getTime());
		String updated_atFormatted = new SimpleDateFormat("yyyy-MM-dd HH-mm-ss")
				.format(Calendar.getInstance().getTime());
	...
	public String saveComment(@RequestParam("post_id") Long postId, Model model, @Valid Comment comment,
